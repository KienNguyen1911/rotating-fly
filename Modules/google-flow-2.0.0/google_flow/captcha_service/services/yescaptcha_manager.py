...
class YesCaptchaTaskManager:
    ...
    async def create_task(self, *, owner_scope: str, task_type: str, metadata: dict[str, Any] | None = None) -> str:
    ...
    async def get_task(self, task_id: str, *, owner_scope: str) -> YesCaptchaTaskRecord | None:
        async with self._lock:
