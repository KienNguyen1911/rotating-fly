...
class GeminiClient(ChatMixin, GemMixin, ResearchMixin):
    ...
    def _parse_candidate(
        ...
        # Immersive document / Deep Research report extraction
        immersive_doc = get_nested_value(candidate_data, [30, 0, 4]) or get_nested_value(candidate_data, [30, 0, 17, 0])
        if immersive_doc and isinstance(immersive_doc, str) and len(immersive_doc) > len(text):
            text = immersive_doc
