...
- [x] **P4.1** Split into 4 separate csproj projects (Core / Infrastructure / Application / UI) — ✅ Done (scaffold; UI/WPF migration deferred) — [p4-project-cleanup.md](./p4-project-cleanup.md)
