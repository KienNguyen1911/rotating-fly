...
| #   | Item                                                                | Status                                       | Report                                           |
| --- | ------------------------------------------------------------------- | -------------------------------------------- | ------------------------------------------------ |
| 4.1 | Split into 4 separate csproj projects                               | ✅ Done (Core+Infra+App+UI projects build; full WPF UI migration deferred) | [p4-project-cleanup.md](./p4-project-cleanup.md) |
...
├─ DEVELOPER-RULES.md                         ← Coding conventions + AI assistant guide
├─ gemini-creator-architecture.md             ← Gemini 5-step pipeline + PipelineOrchestrator docs
...
├─ p3-modular-monolith-and-template-method.md ← P3.1
├─ p3-pipeline-step-migration.md              ← P3.2
├─ p3-mvvm-batch-image-gen-tab.md             ← P3.3
├─ p3-mvvm-gemini-creator-tab.md              ← P3.4
├─ p3-mvvm-profile-tab-scaffolding.md         ← P3.5
├─ p3-mvvm-profile-tab-wiring.md              ← P3.6
├─ p4-magic-numbers.md                        ← P4.1
└─ p4-project-cleanup.md                      ← P4.2
```

---

## 📚 Related Documentation (root)

- [../README.md](../README.md) — Project landing page (quick overview + dev guide pointers).
- [../HOW-TO-RUN.md](../HOW-TO-RUN.md) — Build, run, architecture & DI explanation.
- [../FLOW-API.md](../FLOW-API.md) — Google Flow Image API integration (HTTP endpoints + Python/JS/cURL examples).
