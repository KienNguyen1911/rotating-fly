...
namespace AssetAutomator.Application.Services
{
    public class LicenseService : IDisposable
    {
        ...
        public LicenseService(IConfigService configService)
        {
        ...
        private string GetServerUrl(string? overrideUrl = null)
        {
            if (!string.IsNullOrWhiteSpace(overrideUrl))
                return overrideUrl.Trim();

            return _configService.CurrentSettings.LicenseServerUrl?.Trim() ?? string.Empty;
        }
