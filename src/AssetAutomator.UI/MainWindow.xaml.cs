...
using AssetAutomator.UI.Windows;
    ...
    public partial class MainWindow : Window, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private void SetThemeBrush(string brushKey, string hexColor)
        {
            try
            {
                ...
                System.Windows.Application.Current.Resources[brushKey] = new System.Windows.Media.SolidColorBrush(color);
            }
            catch (Exception ex)
            {
        ...
        {
            var licenseWin = new AssetAutomator.UI.Windows.LicenseWindow(_licenseService)
            {
                Owner = this
            };
        ...
        private void LicenseService_OnSessionInvalidated(object? sender, string reason)
        {
            Dispatcher.Invoke(async () =>
            {
                ...
                var win = new AssetAutomator.UI.Windows.LicenseWindow(_licenseService) { Owner = this };
                win.ShowDialog();
        ...
        public ObservableCollection<string> LanguageList { get; set; } = new ObservableCollection<string>(AppLanguageList.Languages);
        ...
        public MainWindow()
        {
            ...
            _legacyVideoPipelineService = new LegacyVideoPipelineService(configService, _step1, _step2, _step3, _step4, _step5);
        ...
        private void MainWindow_Closing(object? sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            PythonServerManager.Default.StopServer();
        }
